...
const emptyCampaign = { marketingPartnerId: "", name: "", targetScopeType: "NATIONWIDE", targetProvince: "", targetDistrict: "", requestedQuantity: 0 };
      ...
      <div className="grid gap-6 xl:grid-cols-3">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-4 space-y-3">
            ...
            <button disabled={working} onClick={async () => { const result = await submit("/api/marketing-cards/admin/campaigns", campaign, "Campaign created."); if (result) setCampaign(emptyCampaign); }} className="w-full rounded-lg bg-slate-900 px-3 py-2 text-sm font-bold text-white disabled:opacity-50">Create campaign</button>
          </div>
        </section>
